  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-black uppercase">🏅 Level Up Badge Stand</h3>
        {activeMilestone && (
          <span className="rounded-full border-2 border-black bg-yellow-300 px-2 py-0.5 text-[10px] font-black text-black shadow-[0_3px_0_rgba(0,0,0,0.4)]">
          ...
          return (
            <button
              ...
              className={`
                ...
                ${claimable ? 'animate-badge-glow bg-yellow-200 hover:scale-110' : ''}
                ${isUnlocked ? 'bg-white hover:scale-110' : ''}
